                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/TextbookReview/user?method=query&adminPage=1&currPage=1">查看用户</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/TextbookReview/textbook?method=query&adminPage=1&currPage=1">查看图书</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/TextbookReview/review?method=query&adminPage=1&currPage=1">查看评论</a></li>
